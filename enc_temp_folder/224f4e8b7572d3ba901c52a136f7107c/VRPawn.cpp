...
void AVRPawn::ThumbstickLeftX(float val)
{
	if (leftHand && leftHand->active)
	{
		...
		// Enables movement when the thumbstick is moved in a given direction.
		// NOTE: Disabled as the knuckles controllers input is not working correctly and needs fixing.
